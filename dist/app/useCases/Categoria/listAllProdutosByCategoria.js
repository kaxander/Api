...
exports.listAllProdutosByCategoria = void 0;
const Produto_1 = require("../../models/Produto");
const mongoose_1 = __importDefault(require("mongoose"));
function listAllProdutosByCategoria(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const produtos = yield Produto_1.Produto.find().where("categoria").equals(id);
...
exports.listAllProdutosByCategoria = listAllProdutosByCategoria;
